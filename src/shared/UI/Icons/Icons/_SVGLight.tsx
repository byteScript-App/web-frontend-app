...
const _SVGLight = ({
	...
	return (
		...
		>
			...
			<path d='M12 20V22' />
			<path d='M4 12L2 12' />
			<path d='M6.31412 6.3146L4.8999 4.90039' />
			<path d='M17.686 6.3146L19.1002 4.90039' />
			<path d='M6.31412 17.6904L4.8999 19.1046' />
			<path d='M17.686 17.6904L19.1002 19.1046' />
			<path d='M22 12L20 12' />
