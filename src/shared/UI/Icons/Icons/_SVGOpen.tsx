...
const _SVGOpen = ({
	...
	return (
		...
		>
			<path d='M18 3L18 6.2C18 7.88016 18 8.72024 17.673 9.36197C17.3854 9.92646 16.9265 10.3854 16.362 10.673C15.7202 11 14.8802 11 13.2 11L13 11' />
