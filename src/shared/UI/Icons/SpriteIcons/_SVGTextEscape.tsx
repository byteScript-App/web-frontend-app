...
const _SVGTextEscape = ({
	...
	return processSpriteIcons({
		...
		defaultState: (
			...
			>
				<rect x='6' y='6' width='36' height='36' rx='6' stroke='#404342' />
				<path
					d='M16 16V16C16 14.8954 16.8954 14 18 14H30C31.1046 14 32 14.8954 32 16V16'
					stroke='#F2FAF9'
				/>
				<path d='M24 14V34' stroke='#F2FAF9' />
			</svg>
		),
		activeState: (
			<svg
				...
				xmlns='http://www.w3.org/2000/svg'
			>
				<rect x='6' y='6' width='36' height='36' rx='6' stroke='#009990' />
				<path
					d='M16 16V16C16 14.8954 16.8954 14 18 14H30C31.1046 14 32 14.8954 32 16V16'
					stroke='#00FFF0'
				/>
				<path d='M24 14V34' stroke='#00FFF0' />
			</svg>
		),
	});
};
