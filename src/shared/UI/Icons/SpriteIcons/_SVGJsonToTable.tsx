		...
		defaultState: (
			...
			>
				...
				<path
					...
					stroke='#404342'
				/>
				<path d='M34 24C34 26.2133 29.5556 28 24 28C18.4444 28 14 26.2133 14 24' stroke='#05A8F2' />
				<path
		...
		activeState: (
			...
			>
				...
				<path
					...
					stroke='#009990'
				/>
				<path d='M34 24C34 26.2133 29.5556 28 24 28C18.4444 28 14 26.2133 14 24' stroke='#00FFF0' />
				<path
					d='M24 20C29.5228 20 34 18.2091 34 16C34 13.7909 29.5228 12 24 12C18.4772 12 14 13.7909 14 16C14 18.2091 18.4772 20 24 20Z'
					stroke='#00FFF0'
				/>
...
export default _SVGJsonToTable;
