...
const _SVGJWT = ({
	...
	return processSpriteIcons({
		...
		defaultState: (
			...
			>
				<path d='M22 12V2H26V12L24 16L22 12Z' stroke='#000403' />
				<path d='M26 46H22V36L24 32L26 36V46Z' stroke='#000403' />
				<path d='M22 12V2H26V12L24 16L22 12Z' stroke='#404342' />
				<path d='M26 46H22V36L24 32L26 36V46Z' stroke='#404342' />
				<path
		...
		activeState: (
			...
			>
				<path d='M22 12V2H26V12L24 16L22 12Z' stroke='#000403' />
				<path d='M26 46H22V36L24 32L26 36V46Z' stroke='#000403' />
				<path d='M22 12V2H26V12L24 16L22 12Z' stroke='#009990' />
				<path d='M26 46H22V36L24 32L26 36V46Z' stroke='#009990' />
				<path
					d='M15.329 15.4671L9.45117 7.37695L12.6872 5.02581L18.5651 13.116L19.2982 17.5276L15.329 15.4671Z'
					stroke='#00FFF0'
				/>
